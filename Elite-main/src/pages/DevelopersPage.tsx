...
const DevelopersPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-transparent text-foreground pt-24 pb-20 px-4 md:px-8">
      ...
      {/* Login Call to Action at the bottom */}
      <div className="max-w-7xl mx-auto py-16 px-4 flex flex-col items-center justify-center border-t border-border/50 mt-10">
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
        ...
        >
          <h2 className="text-3xl font-bold font-outfit text-foreground">
            {t('developers_page.join_title', 'Are you a developer?')}
          </h2>
          <p className="text-muted-foreground font-outfit">
            {t('developers_page.join_desc', 'Join the elite team and showcase your masterpieces to the world. Log in or create an account to get started.')}
          </p>
          <button
            onClick={() => navigate('/login')}
            className="mt-6 px-10 py-4 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white rounded-full font-bold shadow-[0_0_30px_-5px_rgba(139,92,246,0.5)] transition-all duration-300 transform hover:scale-105"
          >

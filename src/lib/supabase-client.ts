// ============================================================================
// EL8 Platform — Supabase Client (static module; import only from code that
// is already behind a lazy route, e.g. the dashboard. Everything else goes
// through getSupabase() in ./supabase.ts so anonymous visitors never download it).
// ============================================================================
//
...
if (isMissingConfig) {
  console.error(
    '\n%c🚨 EL8 — Supabase Configuration Missing!\n',
